...
<div id="mws-navigation">
    <ul>
        ...
        <li>
            ...
            <ul>
                <li><a href="<?php echo U('Admin/Clothes/add');?>">添加</a></li>
            </ul>
        </li>
    ...
    <div class="mws-form-inline">
       ...
       <!--
        ...
        <div class="mws-form-row">
            ...
            <div class="mws-form-item clearfix">
                <ul class="mws-form-list inline">
                    <li><input type="radio" /> <label>男装</label></li>
                    <li><input type="radio" /> <label>女装</label></li>
                    <li><input type="radio" /> <label>通用</label></li>
                </ul>
            </div>
        </div>
    </div>
