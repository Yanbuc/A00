    ...
    <form action="" method="post" class="form form-horizontal" id="demoform-1">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" placeholder="产品编号" value="<?php echo ($data['product_id']); ?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">产品名字</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" placeholder="产品名字" value="<?php echo ($data['product_name']); ?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">产品价格</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" placeholder="产品价格" value="<?php echo ($data['product_price']); ?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">产品数量</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" placeholder="产品数量" value="<?php echo ($data['num']); ?>">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3">产品类别</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" placeholder="产品类别" value="<?php echo ($data['product_type']); ?>">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" placeholder="产品添加日期" value="<?php echo ($data['product_date']); ?>">
            </div>
        </div>
        <!--
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea class="textarea" placeholder="说点什么..." rows="" cols="" name=""><?php echo ($data['product_description']); ?></textarea>
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls skin-minimal col-xs-8 col-sm-9">
                <?php if(is_array($image_id)): foreach($image_id as $k=>$v): ?><div class="check-box">
                        ...
                        <label for="checkbox-<?php echo ($v); ?>"><?php echo ($v); ?>&nbsp;&nbsp;&nbsp;&nbsp;</label>
