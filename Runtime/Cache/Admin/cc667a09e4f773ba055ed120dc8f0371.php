            ...
            <div id="mws-user-info" class="mws-inset">
                ...
                <div id="mws-user-functions">
                    ...
                    <ul>
                        ...
                        <li><a href="../../../../../../admin/index-2.html">Logout</a></li>
                    </ul>
                </div>
            </div>
            <!-- End User Functions -->
    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
            	<ul>
                	<li class="active"><a href="<?php echo U('Admin/DashBoard/index');?>" class="mws-i-24 i-home">Dashboard</a></li>
                	<li><a href="<?php echo U('Admin/Charts/index');?>" class="mws-i-24 i-chart">Charts</a></li>
                   <!-- <li><a href="<?php echo U('Admin/Calendar/index');?>" class="mws-i-24 i-chart">Calendar</a></li>-->
