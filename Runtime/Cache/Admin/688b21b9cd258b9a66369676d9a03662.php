...
<div id="mws-navigation">
    <ul>
        ...
        <li><a href="<?php echo U('Admin/Charts/index');?>" class="mws-i-24 i-chart">Charts</a></li>
        ...
        -->
        <li>
            <a href="../../../../../../admin/icons.html" class="mws-i-24 i-pacman">
        ...
        <span class="mws-report-content">
            	...
            	<div class="mws-panel grid_8">
                	<div class="mws-panel-header">
                    	<span class="mws-i-24 i-sign-post">修改密码</span>
                    </div>
                    <div class="mws-panel-body">
                    	<form class="mws-form" action="<?php echo U('Admin/Chpwd/changePwd');?>" method="post">
                    		<div class="mws-form-inline">
								...
								<div class="mws-form-row">
									<label>密码</label>
									<div class="mws-form-item large">
										<input type="password" class="mws-textinput"  name="password"/>
									</div>
								</div>
                    		</div>
                    		<div class="mws-button-row">
                    			<input type="submit" value="修改" class="mws-button gray  mid"  />
                    		</div>
                    	</form>
                    </div>
                </div>
