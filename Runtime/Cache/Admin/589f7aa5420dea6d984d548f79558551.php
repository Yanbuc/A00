    ...
    <div id="mws-wrapper">
        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-navigation">
            	<ul>
                	<li><a href="<?php echo U('Admin/DashBoard/index');?>" class="mws-i-24 i-home">Dashboard</a></li>
                	<li><a href="<?php echo U('Admin/Charts/index')" class="mws-i-24 i-chart">Charts</a></li>
                	<li class="active"><a href="{:U('Admin/Calendar/index');?>" class="mws-i-24 i-day-calendar">Calendar</a></li>
                	<li>
