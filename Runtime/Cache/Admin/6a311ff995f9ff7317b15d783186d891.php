...
<form action="" method="post" class="form form-horizontal" id="demoform-1">
    ...
    <div class="row cl">
            ...
            <div class="mws-form-item large">
                <input type="hidden" value="<?php echo ($data['product_id']); ?>" id="product_id">
                <input id="product_image" type="file" class="mws-textinput" name="clothesImage" value="选择图片" />
            </div>
        </div>
    ...
    <div class="row cl">
        <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input class="btn btn-primary radius" type="button" value="提交" onclick="uploadImage()">
        </div>
    </div>
</form>
</body>
